...
*This project is analysed on https://sonarcloud.io/dashboard?id=sonarsource-cfamily-examples_macos-xcode-travis-sc[SonarQube Cloud]!*
...
A build of the https://github.com/sonarsource-cfamily-examples/code[code repository] on a macOS platform using XCode build system.
